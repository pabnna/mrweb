...
<section class="no-results not-found">
	<header class="page-header">
		<h2 class="page-title"><?php _e( 'Nothing Found', 'sociallyviral' ); ?></h2>
	</header><!-- .page-header -->
	...
	<div class="page-content">
		...
		<?php else : ?>
			...
			<p><?php _e( 'It seems we can&rsquo;t find what you&rsquo;re looking for. Perhaps searching can help.', 'sociallyviral' ); ?></p>
			<?php get_search_form(); ?>
